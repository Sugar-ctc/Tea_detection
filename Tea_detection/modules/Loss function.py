...
class YOLOLoss(nn.Module):
    ...
    def build_targets(self, predictions, targets, imgs):
        ...
        for batch_idx in range(predictions[0].shape[0]):
            #-------------------------------------------#
            #   First determine which of the real boxes on the match belong to the image
            #-------------------------------------------#
            b_idx       = targets[:, 0]==batch_idx
            this_target = targets[b_idx]
            #-------------------------------------------#
            #   If no real boxes belong to the picture, continue
            #-------------------------------------------#
            if this_target.shape[0] == 0:
                continue
            
            #-------------------------------------------#
            #   The coordinates of the real box are scaled
            #-------------------------------------------#
            txywh = this_target[:, 2:6] * imgs[batch_idx].shape[1]
            #-------------------------------------------#
            #   Center width to upper left corner and lower right corner
            #-------------------------------------------#
            ...
            for i, prediction in enumerate(predictions):
                #-------------------------------------------#
                #   b represents the number of images and a represents the number of prior boxes
                #   gj represents the y axis and gi represents the x axis
                #-------------------------------------------#
                b, a, gj, gi    = indices[i]
                idx             = (b == batch_idx)
                ...
                #-------------------------------------------#
                #   Take the prediction corresponding to the real box
                #-------------------------------------------#
                ...
                #-------------------------------------------#
                #   Once the grid is obtained, decode it
                #-------------------------------------------#
            ...
            #-------------------------------------------#
            #   Check whether a prediction box exists. If no prediction box exists, skip it
            #-------------------------------------------#
            ...
            #-------------------------------------------#
            #   Find k prediction boxes with the lowest cost
            #-------------------------------------------#
            ...
            #-------------------------------------------#
            #   If one prediction box corresponds to multiple real boxes
            #   Use only the real box that most corresponds to this prediction box
            #-------------------------------------------#
            ...
            #-------------------------------------------#
            #   Remove the boxes that match the conditions
            #-------------------------------------------#
    ...
    def find_3_positive(self, predictions, targets):
        ...
        #------------------------------------#
        #   Create an empty list to hold indices and anchors
        #------------------------------------#
        indices, anchors    = [], []
        ...
        for i in range(len(predictions)):
            ...
            #-------------------------------------------#
            #   b   Represents which picture belongs to
            #   gxy Represents the x and y center coordinates of the real box
            #   gwh Represents the wh coordinates of the real box
            #   gij Represents the feature point coordinates of the real box
            #-------------------------------------------#
            ...
            #-------------------------------------------#
            #   gj、gi Do not go beyond the feature layer
            #   a represents the number of prior boxes belonging to the feature point
            #-------------------------------------------#
