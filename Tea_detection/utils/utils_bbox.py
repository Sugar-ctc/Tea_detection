...
class DecodeBox():
    ...
    def decode_box(self, inputs):
        ...
        for i, input in enumerate(inputs):
            ...
            #-------------------------------------------------#
            #   The size of the obtained scaled_anchors is relative to the feature layer
            #-------------------------------------------------#
            ...
            #-----------------------------------------------#
            #   The prior box's center position adjusts the parameters
            #-----------------------------------------------#
            ...
            #----------------------------------------------------------#
            #   Generate grid, center of the prior box, top left corner of the grid
            #   batch_size,3,20,20
            #----------------------------------------------------------#
    ...
    def yolo_correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        #-----------------------------------------------------------------#
        #   The Y-axis is placed first because it is easy to predict the width of the box and multiply the height of the image
        #-----------------------------------------------------------------#
        box_yx = box_xy[..., ::-1]
        box_hw = box_wh[..., ::-1]
    ...
    def non_max_suppression(self, prediction, num_classes, input_shape, image_shape, letterbox_image, conf_thres=0.5, nms_thres=0.4):
        #----------------------------------------------------------#
        #   Converts the format of the prediction result to the upper-left and lower-right format.
        ...
        for i, image_pred in enumerate(prediction):
            ...
            #----------------------------------------------------------#
            #   The first round of screening is performed using confidence
            #----------------------------------------------------------#
            conf_mask = (image_pred[:, 4] * class_conf[:, 0] >= conf_thres).squeeze()

            #----------------------------------------------------------#
            #   Filter the prediction results according to the confidence degree
            #----------------------------------------------------------#
            ...
            #   The value of 7 is：x1, y1, x2, y2, obj_conf, class_conf, class_pred
            #-------------------------------------------------------------------------#
            ...
            for c in unique_labels:
                #------------------------------------------#
                #   Obtain all prediction results after a certain type of score screening
                #------------------------------------------#
...
if __name__ == "__main__":
    ...
    def get_anchors_and_decode(input, input_shape, anchors, anchors_mask, num_classes):
        ...
        #-------------------------------------------------#
        #   The size of scaled_anchors obtained at this point is relative to the feature layer
