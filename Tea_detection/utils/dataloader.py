...
class YoloDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #---------------------------------------------------#
        #   The real box is preprocessed
        #---------------------------------------------------#
        nL          = len(box)
        labels_out  = np.zeros((nL, 6))
        if nL:
            #---------------------------------------------------#
            #   The real box is normalized and adjusted between 0 and 1
            #---------------------------------------------------#
    ...
    def get_random_data(self, annotation_line, input_shape, jitter=.3, hue=.1, sat=0.7, val=0.4, random=True):
        ...
        #------------------------------#
        #   The image is read and converted to RGB image
        #------------------------------#
        image   = Image.open(line[0])
        image   = cvtColor(image)
        #------------------------------#
        #   The image height width and target height width are obtained
        #------------------------------#
        iw, ih  = image.size
        h, w    = input_shape
        #------------------------------#
        ...
        #---------------------------------#
        #   The color gamut of the image is transformed
    ...
    def get_random_data_with_Mosaic(self, annotation_line, input_shape, jitter=0.3, hue=.1, sat=0.7, val=0.4):
        ...
        for line in annotation_line:
            ...
            #-----------------------------------------------#
            #   Place the picture, corresponding to the position of the four split pictures
            #-----------------------------------------------#
            if index == 0:
        ...
        #---------------------------------#
        #   Split the pictures and put them together
        #---------------------------------#
