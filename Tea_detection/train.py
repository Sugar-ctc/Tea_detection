...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    #   torch 1.2 unsuppose amp，using torch 1.7.1
    #------------------------------------------------------------------#
    if fp16:
    ...
    if True:
        ...
        #-------------------------------------------------------------------#
        #   batch_size is Unfreeze_batch_size
        #-------------------------------------------------------------------#
        batch_size = Freeze_batch_size if Freeze_Train else Unfreeze_batch_size

        #-------------------------------------------------------------------#
        #   Determine the current batch_size and adjust the learning rate
        #-------------------------------------------------------------------#
        nbs             = 64
        ...
        #---------------------------------------#
        #   The formula of learning rate decline is obtained
        #---------------------------------------#
