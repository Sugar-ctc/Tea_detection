#-------------------------------------------------------#
#   Used to process COCO data sets and generate txt files from json files for training
#-------------------------------------------------------#
import json
import os
...
#-------------------------------------------------------#
#   Points to the path of the COCO training set and verification set pictures
#-------------------------------------------------------#
train_datasets_path     = "coco_dataset/train2017"
val_datasets_path       = "coco_dataset/val2017"

#-------------------------------------------------------#
#   Points to the path of the COCO training set and verification set labels
#-------------------------------------------------------#
