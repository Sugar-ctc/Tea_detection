...
class YOLOLoss(nn.Module):
    ...
    def __call__(self, predictions, targets, imgs): 
        ...
        for i, prediction in enumerate(predictions): 
            ...
            #-------------------------------------------#
            #   Get the number of targets if the target is greater than 0
            #   Species losses and regression losses are calculated
            #-------------------------------------------#
            n = b.shape[0]
            if n:
            ...
            #   And multiplied by the ratio of each feature layer
            #-------------------------------------------#
    ...
    def build_targets(self, predictions, targets, imgs):
        ...
        #-------------------------------------------#
        #   Loop batch_size for OTA matching
        #   Loop the layer in the batch_size loop
        #-------------------------------------------#
